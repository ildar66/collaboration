...
public class _CollaborationClientNRIHome_Stub extends Stub implements CollaborationClientNRIHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.sync.session.CollaborationClientNRIHome:0000000000000000", 
    ...
    public CollaborationClientNRI create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (CollaborationClientNRI) in.read_Object(CollaborationClientNRI.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.sync.session.CollaborationClientNRIHome.class);
            if (so == null) {
                return create();
            }
            try {
                CollaborationClientNRI result = ((com.hps.july.sync.session.CollaborationClientNRIHome)so.servant).create();
                return (CollaborationClientNRI)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
