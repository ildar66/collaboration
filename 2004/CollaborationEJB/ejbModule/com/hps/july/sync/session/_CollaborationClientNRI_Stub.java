...
public class _CollaborationClientNRI_Stub extends Stub implements CollaborationClientNRI {
    ...
    public void process() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("process",com.hps.july.sync.session.CollaborationClientNRI.class);
            if (so == null) {
                process();
                return;
            }
            try {
                ((com.hps.july.sync.session.CollaborationClientNRI)so.servant).process();
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
