...
*/	
	...
	public GenericDAO_0() throws ReferencesDAOSysException {
		try {
	...
	private GenericDAO_0(String daoSQLFileName, String database) throws ReferencesDAOSysException {
		try {
			SAXParserFactory parserFactory = SAXParserFactory.newInstance();
			parserFactory.setValidating(true);
			parserFactory.setNamespaceAware(true);
