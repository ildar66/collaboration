...
<%
	ReferencesForm_1 listForm = (ReferencesForm_1)session.getAttribute("referencesForm_1");
...
<BODY>
<html:errors />
<html:form action="/references_1" styleId="thisForm">
	...
	<TABLE class="gridfoot">
		<TBODY>
			<TR>
				...
				<TD align=right>Страница <html:text name="referencesForm_1" property="pagenumber" size="3"/> из <%=pagecount%>.</TD>
				<TD><INPUT type=button value="Обновить" onclick="Refresh()"></TD>
				<TD align=right>Размер страницы <html:text name="referencesForm_1" property="pagesize" size="3"/></TD>
			</TR>
		</TBODY>
	</TABLE>
	<%}%>
