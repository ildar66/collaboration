...
<%
/**
	GenericForm listForm = (GenericForm)session.getAttribute("genericForm");
...
<BODY>
<html:errors />
<html:form action="/generic" styleId="thisForm">
...
{ 
	...
	<logic:present name="genericForm" property="page">
	
		<TABLE class="gridfoot">
			<TBODY>
				<TR>
					<TD>
						<logic:equal name="genericForm" property="page.previousPageAvailable" value="true">
							<INPUT type=button value="  &lt;   " onclick="MoveTo('previous')">
						</logic:equal>
						<logic:equal name="genericForm" property="page.nextPageAvailable" value="true">						
							<INPUT type=button value="   &gt;  " onclick="MoveTo('next')">
						</logic:equal>
					</TD>
					<TD>номер старт. записи: <html:text name="genericForm"
						property="start" size="5" />.</TD>
					<TD>записей на странице: <html:text name="genericForm"
	...
	<TABLE border="1">
		<TBODY>
			<!-- Table header -->
			<TR>
				<logic:iterate id="it" name="genericForm"
