...
function NSResize() {
   ...
   top.navigation_tree.location.reload();
...
ProgressImage.src = "/admin/images/appInstall_animated.gif";
...
if (isNav4) {
        document.write("<layer id='progress' visibility='hide' width='200' Z-INDEX='0' top='100' left='200' bgColor='#999999'><table width='200' border='0' cellpadding='3' cellspacing='1'><tr><td class='table-text'><img src='/admin/images/appInstall_animated.gif' align='texttop'>" + top.pleaseWait + "</td></tr></table></layer>");
