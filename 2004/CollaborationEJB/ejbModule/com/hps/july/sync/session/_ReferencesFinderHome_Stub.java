...
public class _ReferencesFinderHome_Stub extends Stub implements ReferencesFinderHome {
    
    private static final String[] _type_ids = {
        "RMI:com.hps.july.sync.session.ReferencesFinderHome:0000000000000000", 
    ...
    public ReferencesFinder create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ReferencesFinder) in.read_Object(ReferencesFinder.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",com.hps.july.sync.session.ReferencesFinderHome.class);
            if (so == null) {
                return create();
            }
            try {
                ReferencesFinder result = ((com.hps.july.sync.session.ReferencesFinderHome)so.servant).create();
                return (ReferencesFinder)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
